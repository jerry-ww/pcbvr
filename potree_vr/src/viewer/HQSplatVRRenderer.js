...
class HQSplatVRRenderer {
	...
	render () {
		...
		{ // DEPTH PASS
			...
			this.effect.render(viewer.scene.scenePointCloud, camera, this.rtDepth, {
		...
		{ // ATTRIBUTE PASS
			...
			this.effect.render(viewer.scene.scenePointCloud, camera, this.rtAttribute, {
		...
		{ // NORMALIZATION PASS
			...
			Potree.utils.screenPass.render(this.effect, normalizationMaterial);
		}

		//viewer.renderer.render(viewer.scene.scene, camera);
		this.effect.render(viewer.scene.scene, camera);
		...
		this.effect.render(viewer.controls.sceneControls, camera);
		this.effect.render(viewer.clippingTool.sceneVolume, camera);
		this.effect.render(viewer.transformationTool.scene, camera);
